...
- [ ] 03-02-PLAN.md — Wire form fields, validation UI, metadata POST, text-only path, and confirmation in ShareStory
- [ ] 03-03-PLAN.md — Build/test gate + manual end-to-end verification of all submission paths
