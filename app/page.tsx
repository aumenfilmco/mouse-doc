...
function ShareStory() {
  ...
  return (
    <section id="story" style={{
      background: COLORS.darkGray, padding: "100px 24px",
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        <FadeIn delay={0.15}>
          <h2 style={{
            ...
            fontWeight: 800, color: COLORS.white, lineHeight: 1.2,
            margin: "28px 0 16px",
          }}>
            Were you coached by Mouse?
          </h2>
          <p style={{
            fontFamily: "'Source Sans 3', sans-serif", fontSize: 16, color: COLORS.warmGray,
            ...
            memo, and upload it here. Tell us your favorite memory, what Coach McCollum meant to you,
            or a story nobody else knows.
          </p>
        </FadeIn>
        {!submitted ? (
          <FadeIn delay={0.3}>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <input
                  ...
                  style={{
                    ...
                    padding: "14px 16px", background: COLORS.midGray,
                    border: `1px solid ${COLORS.warmGray}30`, color: COLORS.white,
                    outline: "none",
                  }}
                ...
                />
                <input
                  type="text" placeholder="Your connection to Coach McCollum"
              ...
              <div
                ...
                style={{
                  border: `2px dashed ${dragOver ? COLORS.red : COLORS.warmGray + "40"}`,
                  background: dragOver ? `${COLORS.red}08` : COLORS.cardGray,
                  padding: "48px 24px",
                  textAlign: "center",
                  cursor: "pointer",
                  transition: "all 0.3s",
              ...
              >
                <input
                  id="file-input" type="file" multiple accept="video/*,audio/*"
                  style={{ display: "none" }}
                ...
                <p style={{
                  ...
                  color: COLORS.white, fontWeight: 600, margin: "0 0 8px",
                }}>
                ...
                <p style={{
                  ...
                  or click to browse — accepts video and audio files
                </p>
              </div>
              {/* File list */}
              {files.length > 0 && (
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {files.map((f, i) => (
                    <div key={i} style={{
                      ...
                      background: COLORS.midGray, padding: "10px 16px",
                      borderLeft: `3px solid ${COLORS.red}`,
                    }}>
                      <span style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: 14, color: COLORS.lightGray }}>
                        {f.name}
                      </span>
                      <span style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: 12, color: COLORS.warmGray }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: COLORS.red, border: "none", padding: "16px 40px",
                  cursor: "pointer", alignSelf: "flex-start",
                  transition: "background 0.3s",
                }}
                onMouseEnter={e => (e.target as HTMLButtonElement).style.background = COLORS.darkRed}
                onMouseLeave={e => (e.target as HTMLButtonElement).style.background = COLORS.red}
              >
                SUBMIT YOUR STORY
              </button>
              <p style={{
                fontFamily: "'Source Sans 3', sans-serif", fontSize: 12,
                color: COLORS.warmGray, margin: 0, fontStyle: "italic",
              }}>
          ...
          <FadeIn>
            <div style={{
              background: COLORS.cardGray, padding: "48px 32px",
              borderLeft: `4px solid ${COLORS.red}`, textAlign: "center",
            }}>
              <div style={{ fontSize: 48, marginBottom: 16 }}>🙏</div>
              <h3 style={{
                fontFamily: "'Playfair Display', Georgia, serif", fontSize: 24,
                color: COLORS.white, margin: "0 0 12px",
              }}>Thank you{name ? `, ${name}` : ""}.</h3>
              <p style={{
                fontFamily: "'Source Sans 3', sans-serif", fontSize: 15,
                color: COLORS.warmGray, lineHeight: 1.6, margin: 0,
              }}>
                Your story matters. We&apos;ll review your submission and may reach out to
